...
const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        <b className="font-bold">Hi, I&apos;m Sakshi.</b>{" "}
        I&apos;m a <b className="font-bold">full-stack developer</b> with a passion for{" "}
        <i className="italic">building modern web applications</i>. My focus is{" "}
        <u className="underline">React.js, Node.js & FastAPI</u>.
      </motion.h1>
